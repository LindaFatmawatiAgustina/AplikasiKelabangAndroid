...
class DetailLaporan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra("detail")) {
            ...
            if (laporan != null) {
                Glide.with(this)
                    .load("http://192.168.1.5/aplikasikelabang/public/asset-template/img/${laporan.fileGambar}")
                    .into(detailLaporanBinding.detailGambarJalan)
                Glide.with(this)
                    .load("http://192.168.1.5/aplikasikelabang/public/asset-template/img/${laporan.fileGambar2}")
                    .into(detailLaporanBinding.detailGambarJalan2)
                Glide.with(this)
                    .load("http://192.168.1.5/aplikasikelabang/public/asset-template/img/${laporan.fileGambar3}")
